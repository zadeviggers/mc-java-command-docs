...
- Returns value from colours list in [`minecraft:custom_model_data` component](../item-components/#minecraftcustom_model_data-)
- Fields:
...
- Fields:
  - `default`: RGB value to return when there is no context entity, entity is not in a team or team has no colour
