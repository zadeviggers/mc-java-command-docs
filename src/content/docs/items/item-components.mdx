...
- Format: object with fields
  - `rgb`: [integer, RGB value](/other/colours/#packed-integer-format)
  - `show_in_tooltip`: boolean (default: `true`)
  - e.g. `dyed_color={rgb:16711680}`
  - Alternatively, can be defined as an inline [integer RGB value](/other/colours/#packed-integer-format)
