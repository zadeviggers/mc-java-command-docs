...
### Entity variant components <Badge text="Since 1.21.5" variant="caution" />
...
- `wolf/sound_variant`: namespaced id from [`wolf_sound_variant` registry](https://minecraft.wiki/w/Wolf#Sound_variants_2)
- `wolf/collar`: one of [16 dye colors](/other/colours/#16-core-colours)
- `cat/variant`: namespaced id from [`cat_variant` registry](https://minecraft.wiki/w/Cat#Appearance)
- `cat/collar`: one of [16 dye colors](/other/colours/#16-core-colours)
...
- `tropical_fish/base_color`: one of [16 dye colors](/other/colours/#16-core-colours)
- `tropical_fish/pattern_color`: one of [16 dye colors](/other/colours/#16-core-colours)
...
- `cow/variant`: namespaced id from the [`cow_variant` registry](https://minecraft.wiki/w/Cow#Variants)
- `chicken/variant`: namespaced id from the [`chicken_variant` registry](https://minecraft.wiki/w/Chicken#Variants)
...
- `painting/variant`: namespaced id from [`painting_variant` registry](https://minecraft.wiki/w/Painting#Canvases)
- `sheep/color`: one of [16 dye colors](/other/colours/#16-core-colours)
- `shulker/color`: one of [16 dye colors](/other/colours/#16-core-colours)

### `minecraft:custom_data`

- Can be used for custom data storage on an item
- <Badge text="Since 1.21.5" variant="tip" size="small" /> Can also be applied to
  entities under the `data` attribute to store data on them{" "}
...
### `minecraft:unbreakable` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:enchantments` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:stored_enchantments` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:custom_name` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:can_break` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:can_place_on` <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:dyed_color` <Badge text="Changed in 1.21.5" variant="caution" />

- Represents a color applied to a dyeable item (in the `#minecraft:dyeable` item tag)
- Format: RGB value
  - e.g. `dyed_color=16711680` [(integer format)](/other/colours/#packed-integer-format)
  - e.g. `dyed_color=[0.5, 1.0, 0.2]` [(array format)](/other/colours/#channel-percentages-array-format)
- To modify the tooltip, see [`minecraft:tooltip_display`](#minecrafttooltip_display)

### `minecraft:attribute_modifiers` <Badge text="Changed in 1.21.5" variant="caution" />
...
- Format: [integer, RGB value](/other/colours/#packed-integer-format)
...
### `minecraft:potion_contents` <Badge text="Changed in 1.21.5" variant="caution" />
...
- Format: object with fields
  ...
  - `custom_color`: [integer, RGB value](/other/colours/#packed-integer-format) (optional)
...
### `minecraft:potion_duration_scale` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:trim` <Badge text="Changed in 1.21.5" variant="caution" />
...
- Format: object with fields
  - `shape`: one of
    ...
    - `creeper`
    - `burst`
  - `colors`: integer array, [RGB values](/other/colours/#packed-integer-format) (default: `[]`)
    - List of initial particle colors, randomly selected from
  - `fade_colors`: integer array, [RGB values](/other/colours/#packed-integer-format) (default: `[]`)
...
### `minecraft:jukebox_playable` <Badge text="Since 1.21" variant="tip" /> <Badge text="Changed in 1.21.5" variant="caution" />
...
### `minecraft:weapon` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:blocks_attacks` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:break_sound` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:provides_banner_patterns` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:provides_trim_material` <Badge text="Since 1.21.5" variant="tip" />
...
### `minecraft:tooltip_display` <Badge text="Since 1.21.5" variant="tip" />
...
- Format: object with fields:
  ...
  - `hidden_components`: list of item component ids (default: ~)
    ...
    - If that component provides no tooltip, it will have no effectimport { Aside, Badge } from "@astrojs/starlight/components";import { Aside, Badge } from "@astrojs/starlight/components";import { Aside, Badge } from "@astrojs/starlight/components";
