...
Item stack components is a system for customising all aspects
of an item. It replaces the old NBT system for item customisation.

Content on this page is largely pulled from the offical minecraft patch notes, with light editing and formatting.
...
### `minecraft:custom_model_data` <Badge text="Replaces NBT feature" variant="note" /> <Badge text="Changed in 1.21.4" variant="caution" />
...
### `minecraft:block_entity_data` <Badge text="Replaces NBT feature" variant="note" /> <Badge text="Changed in 1.21.4" variant="caution" />
